...
app.controller('scRegistrationCtrl',function($scope, toastr, catalog, identity, followedInstructors, userDataFollowedInstructors) {
  $scope.identity = identity;
  $scope.catalog = catalog.query();

  userDataFollowedInstructors.getFollowedInstructors().success(function(data) {
    console.log(data);
  })
